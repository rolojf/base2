	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mm-fondo')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('mm-titulo')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Validación Rápida')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('mm-explic')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Contesta lo siguiente para validar que eres humano y no un bot')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('mm-fondo-reto')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('mm-reto')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Resuleve la siguiente ecuación: ')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('mm-acomodo-ecuacion')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$for('valor')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('número')
											])),
										A2(
										$elm$html$Html$input,
										_List_fromArray(
